...
class MarksheetInConstructor{
	...
	MarksheetInConstructor(int a, int b, int c, int d, int e){
		java = a;
		dbs = b;
		python = c;
		cpp = d;
	...
	public static void main(String[] args) {
		...
		MarksheetInConstructor obj = new MarksheetInConstructor(java, dbs, python, cpp, ds);
